...
@app.route('/')
def index():
    session['firstName'] = session.get('firstName',None)
    session['lastName'] = session.get('lastName',None)
    session['birthdate'] = session.get('birthdate',None)
    session['email'] = session.get('email',None)
    session['password'] = session.get('password',None)
    session['confirmPassword'] = session.get('confirmPassword',None)
