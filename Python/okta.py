...
API_TOKEN = "your-api-token"  # This is your SSWS API token
NAMESPACE_LABEL = "Salesforce"  # The App Label (namespace) you're targeting
...
def find_app_by_label(app_label):
